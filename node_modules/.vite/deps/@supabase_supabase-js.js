...
var DEFAULT_HEADERS2 = { "X-Client-Info": `postgrest-js/${version2}` };
...
var DEFAULT_HEADERS3 = { "X-Client-Info": `realtime-js/${version3}` };
var VSN = "1.0.0";
...
var DEFAULT_HEADERS4 = { "X-Client-Info": `storage-js/${version4}` };
...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => __awaiter4(void 0, void 0, void 0, function* () {
      return yield (yield import("./browser-ponyfill-DSS3PQ3G.js")).fetch(...args);
    });
  } else {
    _fetch = fetch;
...
var resolveFetch2 = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => __awaiter7(void 0, void 0, void 0, function* () {
      return yield (yield import("./browser-ponyfill-DSS3PQ3G.js")).fetch(...args);
    });
  } else {
    _fetch = fetch;
